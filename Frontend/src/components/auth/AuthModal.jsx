          ...
          >
            <GlassCard className="p-8 neon-border relative overflow-hidden">
              ...
              <p className="text-muted-foreground text-sm mb-6">
                {isLogin ? "Enter your credentials to continue your quest." : "Join the community and start leveling up today."}
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <Input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 bg-secondary/40 border-border" placeholder="••••••••" required />
                  </div>
                </div>

                <Button type="submit" className="w-full bg-gradient-to-r from-primary to-accent text-primary-foreground h-12 glow-primary mt-4">
                  {isLogin ? "Sign In" : "Register"} <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </form>

              <div className="mt-6 text-center">
                <button onClick={() => setIsLogin(!isLogin)} className="text-sm text-muted-foreground hover:text-accent transition-colors">
